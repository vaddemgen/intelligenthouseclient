...
public final class Bme280Utils {
   ...
   * Reads Bme280 data.
   *
   * @link https://github.com/ControlEverythingCommunity/BME280/blob/master/Java/BME280.java
   * @author BME280
   */
  public static Bme280Value readValue(I2CDevice device) throws IOException {
